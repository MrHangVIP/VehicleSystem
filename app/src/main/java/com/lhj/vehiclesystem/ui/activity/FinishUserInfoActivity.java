...
public class FinishUserInfoActivity extends BaseActivity {
    private static final String TAG = "FinishUserInfoActivity";
    ...
    private void showDriverLevels() {
        ...
        dirverLevelsDialog = WheelViewDialogUtil.showWheelViewDialog(FinishUserInfoActivity.this, "驾照等级选择", new WheelViewDialog.DialogSubmitListener() {
            @Override
