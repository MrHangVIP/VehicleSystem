 ...
 */
public class MyUseRecordActivity extends BaseActivity implements RecyclerDataLoadListener {
    private static final String TAG = "MyUseRecordActivity";
    ...
    protected void findViews() {
        ...
        VehicleRecordAdapter adapter = new VehicleRecordAdapter(mContext);
